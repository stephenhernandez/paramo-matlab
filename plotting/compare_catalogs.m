...
minLon = floor(10*min([eqlon1; eqlon2]))/10;
maxLon = ceil(10*max([eqlon1; eqlon2]))/10;
minLat = floor(10*min([eqlat1; eqlat2]))/10;
maxLat = ceil(10*max([eqlat1; eqlat2]))/10;
...
plot(ax(laxes+1),[eqlon1';eqlon2'],[eqlat1';eqlat2'],'-',"linewidth",0.05,"Color",[0.5 0.5 0.5]); zoom on;
