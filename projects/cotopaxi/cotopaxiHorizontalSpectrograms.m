function S = cotopaxiHorizontalSpectrograms()
%clear;
cd ~/research/now/cotopaxi/horizontalSpectrograms/
...
%%
dayVec = (datetime(2022,10,22):-1:datetime(2022,10,22))';
lDays = length(dayVec);
...
for i = 1:lDays
    ...
    for j = 1:lS
        ...
        colormap parula;
        fName = strcat('EC.',kstnm,'..',charkcmpnm,'_',datestr(dayStart,'yyyy.mm.dd'),"_VLF-HF.jpg");
        print('-djpeg',fName);
        cd ..;
        close all;
        cd ..
