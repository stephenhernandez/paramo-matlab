...
if verboseFlag
    ...
    fprintf("sncl: %s.%s.%s.%s; first time: %s; gapFlag: %d; nOverlaps: %d; nrows: %d; ncols: %d; nGaps: %d, npts: %d\n",...
        ntwk,stnm,locid,chan,firstTime,gapFlag,nOverlaps,...
        sizeE(1),sizeE(2),size(gapInfo,1),npts);
end