function [tPotential,maxAmpRMS,pksOrig,Neff,templateIndex,pks] = sangayRegionalUniqueEvents_v2()
load('~/research/now/sangay/SangayRegionalAnalysis_v2','tabs','pks','templateIndex','maxAmpRMS','pksOrig','Neff');
...
%%
badI = badI | Neff == 0 | (Neff == 1 & pksOrig < 9.5) | ...
    (Neff == 2 & pksOrig < 9) | ...
    (Neff == 3 & pksOrig < 8.5) | ...
    (Neff == 4 & pksOrig < 8) | ...
    (Neff == 5 & pksOrig < 7.5) |...
