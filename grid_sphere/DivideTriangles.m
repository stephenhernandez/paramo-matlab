...
% triangle.  Work in Cartesian coordinates, projecting onto a unit sphere at
% each iteration.  The resulting points are evenly spaced in great circle angle,
% not latitude and/or longitude, which ensures correct handling of the poles.
