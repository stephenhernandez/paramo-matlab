...
% considered equal.  Sorts output in order of increasing ones.  Breaks ties
% among points with ones that differ only by rounding errors with a secondary
% sort in order of increasing twos.
% 
